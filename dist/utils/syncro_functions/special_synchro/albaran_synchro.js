...
const UpdateFacturasChanges = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    dataLocal = localDB_config_1.default.query((0, albaran_query_1.get_ids_pedidos_to_update)()); // || p.id | p.pedidoventa | f.id | f.factura | a.id | a.albaran || 
    ...
    if (data_changes.length > 0) {
        ...
        console.log(`||--|| NO SE REALIZARON ACTUALIZACIONES DE FACTURAS : ${(0, utils_1.obtenerFechaActual)()} ||--||`);
    }
});
