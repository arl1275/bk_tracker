...
const getCajasFactura_controller = (req, res) => { (0, facturas_service_1.getCajasFactura_service)(req, res); };
exports.getCajasFactura_controller = getCajasFactura_controller;
//---------------------- ADMINI ROUTE -------------------//
